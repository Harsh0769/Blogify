...
const Signup = () => {
    ...
    const [user, setUser] = useState({
        name: "", email: "", password: "", role: "user", profilePic: "",
    });
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <select
                                ...
                                value={user.role}
                                onChange={handleChange}
                                className="border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-amber-400 hover:border-gray-300 transition-colors bg-white text-gray-700"
                            >
